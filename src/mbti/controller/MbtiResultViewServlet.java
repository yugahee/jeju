...
public class MbtiResultViewServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(test1 == 1 && test2 == 1 && test3 == 1 && test4 == 1) {
			...
			mbti.setReco("레고박물관 브릭캠버스");
			mbti.setRecoContent("어딜봐도 레고가 가득한 레고 박물관 브릭캠버스!\n여행지의 모든 것을 알고 싶은 정보탐구형 INTJ에게 딱!");
			...
			mbti.setReco("레고박물관 브릭캠버스");
			mbti.setRecoContent("어딜봐도 레고가 가득한 레고 박물관 브릭캠버스!\n다양한 공간과 체험은 리더력을 발산하고픈 ENTJ에게 딱!");
			...
			mbti.setReco("레고박물관 브릭캠버스");
			mbti.setRecoContent("어딜봐도 레고가 가득한 레고 박물관 브릭캠버스!\n풍부한 상상력으로 로맨틱한 순간을 원하는 INFP에게 딱!");
			...
			mbti.setReco("레고박물관 브릭캠버스");
			mbti.setRecoContent("어딜봐도 레고가 가득한 레고 박물관 브릭캠버스!\n즉흥여행을 좋아하는 ENFP를 순식간에 감성 속으로 초대합니다! 게-하");
			...
			mbti.setReco("레고박물관 브릭캠버스");
			mbti.setRecoContent("어딜봐도 레고가 가득한 레고 박물관 브릭캠버스!\n스케줄 관리에 철저한 ISTJ에게 딱 맞는 복합문화공간!");
			...
			mbti.setReco("레고박물관 브릭캠버스");
			mbti.setRecoContent("어딜봐도 레고가 가득한 레고 박물관 브릭캠버스!\nESTP라면 다양한 이벤트를 즐기며 소울메이트를 만날지도!");
