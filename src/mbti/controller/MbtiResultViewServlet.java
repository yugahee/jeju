...
public class MbtiResultViewServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(test1 == 2 && test2 == 1 && test3 == 1 && test4 == 2) {
			...
			mbti.setReco("빛의 벙커");
			mbti.setRecoContent("시각 그 이상의 예술을 경험할 기회!\n여행지의 모든 것을 알고 싶은 정보탐구형 INTJ에게 강력 추천!");
		...
		} else if(test1 == 2 && test2 == 2 && test3 == 1 && test4 == 2) {
			...
			mbti.setReco("세리월드");
			mbti.setRecoContent("열기구도 있고~~ 미로도 있고~~ 승마도 있고~~ 카트도 있고 또...\n혼자서도 제대로 즐길 줄 아는 ISTP형에게 강추!");
			...
			mbti.setRecoContent("홈메이드 감성 카페+청결한 게스트하우스의 끝내주는 조합!\nESTP라면  자유로운 분위기 속에서 소울메이트를 만날지도!");
