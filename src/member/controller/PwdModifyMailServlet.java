...
/**
 * Servlet implementation class PwdModifyMailServlet
 */
@WebServlet("/modify/mailSent")
public class PwdModifyMailServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PwdModifyMailServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		/* 비밀번호 변경 시 입력받은 메일 주소로 인증코드 보내는 서블릿 */
